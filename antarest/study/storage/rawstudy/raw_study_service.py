...
from antarest.study.model import DEFAULT_WORKSPACE_NAME, STUDY_VERSION_9_2,STUDY_VERSION_9_3, RawStudy, Study, StudyAdditionalData
        ...
        if StudyVersion.parse(study.version) >= STUDY_VERSION_9_2:
            ...
            if "compatibility" in ini_content and "hydro-pmax" in ini_content["compatibility"]:
                ...
                if hydro_pmax_value != "hourly" and hydro_pmax_value != "daily":
                    raise NotImplementedError(f"AntaresWeb doesn't support the value {hydro_pmax_value} for the flag 'hydro-pmax'")
        ...
        if StudyVersion.parse(study.version) >= STUDY_VERSION_9_3:
            ...
            if "compatibility" in ini_content and "hydro-rule-curves" in ini_content["compatibility"]:
                ...
                if hydro_rule_curves_value!="single":
                    raise NotImplementedError(f"AntaresWeb doesn't support the value {hydro_rule_curves_value} for the flag 'hydro-rule-curves'")